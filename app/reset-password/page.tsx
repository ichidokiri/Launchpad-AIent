...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="min-h-screen w-full sm:w-auto flex items-center justify-center p-4 sm:p-0">
      ...
      <div className="w-full max-w-md min-h-[700px] space-y-8 bg-white/20 dark:bg-black/20 backdrop-blur-sm rounded-3xl p-4 sm:p-8 shadow-xl relative z-10 border border-white/20 dark:border-black/20">
