...
export default function DashboardPage() {
  ...
  //   }
  // }, [user, fetchAgents])
  // !! Agents should be immutable, why delete?
  ...
  //     if (!response.ok) {
  //       throw new Error(
  //         data?.error || data?.message || "Failed to delete agent"
  //       );
  //     }
  ...
  //     toast.error(
  //       error instanceof Error ? error.message : "Failed to delete the AI agent"
  //     );
  //   }
  // };
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent
                            align="end"
                            className="border-2 border-white bg-[#1f1f1f]"
                          >
                            <DropdownMenuItem
              ...
              <TabsContent value="debug">
                <div className="mb-6">
                  ...
                  <p className="text-gray-300">
                    Troubleshoot database and system issues
                  </p>
                </div>
